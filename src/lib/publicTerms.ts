...
export const PUBLIC_TERMS_SECTIONS: PublicTermsSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Where reasonably practical, Betech will avoid unnecessarily displaying personal information that directly identifies an individual customer when publishing installation photographs or videos.",
      ...
      "The presence of an individual incidentally in the installation environment will be handled with reasonable regard for privacy and applicable data-protection requirements.",
      ...
      "Customers are therefore encouraged to communicate any privacy concerns concerning photography, video recording or publication before installation work begins.",
      "A customer’s request not to have their installation published for marketing purposes does not necessarily prevent Betech from taking reasonable technical photographs or videos required for legitimate installation and service purposes.",
      "Such records are not automatically intended for public marketing merely because they were photographed or recorded.",
      "If photographs or videos of an installation have already been published by Betech and the customer does not wish the content to remain publicly displayed, the customer may contact Betech and request that the content be reviewed or removed.",
      "Betech will consider the request and, where appropriate and reasonably practicable, remove the relevant content from websites, social-media accounts or other platforms under Betech’s direct control within a reasonable period.",
      "Removal from Betech-controlled platforms may not automatically remove copies that were previously shared, downloaded, reposted, cached, indexed, screenshotted or otherwise reproduced by third parties outside Betech’s reasonable control.",
      "Where applicable, Betech may nevertheless take reasonable steps regarding content under its control.",
      "Where specific consent was obtained from a customer or another individual for identifiable marketing content, that person may contact Betech to withdraw their consent for future use, subject to applicable law.",
      ...
      "Customers who have particular privacy, confidentiality or security requirements relating to their premises should inform Betech before installation or before photography or recording takes place.",
      "This is particularly important for installations at premises where photography may be restricted or sensitive, including businesses, institutions, controlled-access premises or locations containing confidential information.",
      "Betech will take reasonable steps to accommodate privacy restrictions communicated before or during installation, subject to any technical documentation reasonably required for the installation, safety, warranty, service or applicable legal obligations.",
      "Where content has lawfully been published online, Betech cannot guarantee that third parties will not download, screenshot, share, repost, archive, index or otherwise reproduce that content.",
      "Where a valid removal request is accepted, Betech’s responsibility is generally limited to taking reasonable steps regarding copies or publications under Betech’s control, subject to applicable law.",
      "Photographs, videos and other installation records that contain personal data will be handled subject to applicable data-protection requirements.",
    ...
    bullets: [
      ...
      "Safety",
      "Technician or internal technical review",
