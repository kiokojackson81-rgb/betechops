          ...
          {duplicatedProducts.map((product, index) => {
            ...
            return (
              <div
                ...
                className="w-[86vw] max-w-[380px] shrink-0 snap-start overflow-hidden rounded-[30px] border border-white/12 bg-[linear-gradient(180deg,#fffaf1_0%,#ffffff_100%)] text-slate-950 shadow-[0_22px_48px_rgba(0,0,0,0.18)]"
              >
                <div className="relative h-[240px] w-full overflow-hidden border-b border-[#7a0000]/10 bg-[#fff7ed]">
                  <Image
                    src={product.image}
                    alt={product.name}
                    fill
                    sizes="(max-width: 1024px) min(86vw, 380px), 380px"
