    ...
    <article className="group flex h-full flex-col overflow-hidden rounded-[28px] border border-[#7a0000]/10 bg-[linear-gradient(180deg,#fffaf1_0%,#ffffff_100%)] text-slate-950 shadow-[0_18px_40px_rgba(15,23,42,0.06)] transition duration-300 hover:-translate-y-1.5 hover:shadow-[0_28px_60px_rgba(122,0,0,0.14)]">
      ...
      <div className="flex flex-1 flex-col p-3 sm:p-4">
        ...
        <Link href={`/shop/product/${product.slug}`} className="mt-2 block">
          <h3 className="line-clamp-2 text-sm font-black leading-6 text-slate-950 transition group-hover:text-[#7a0000] sm:text-base">{product.name}</h3>
        </Link>
        ...
        <div className="mt-4 grid gap-2 sm:mt-5">
          ...
          <Link
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex min-h-[2.9rem] items-center justify-center gap-2 rounded-2xl border border-[#7a0000]/12 bg-white px-4 py-2 text-sm font-bold text-[#7a0000] transition hover:-translate-y-0.5"
          >
