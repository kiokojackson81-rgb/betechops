  ...
  const addCatalogProduct = (product: CatalogProduct) => {
    setItems((current) => [
      ...current,
      {
        ...
        commissionAmount:
          product.commissionAmount == null ? 0 : Number(product.commissionAmount),
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {it.productId ? (
                      <div className="mt-2 flex flex-wrap items-center gap-2 text-[11px] uppercase tracking-wide text-slate-400">
                        ...
                        {it.buyingPrice && Number(it.buyingPrice) > 0 ? <span>Buying KES {Number(it.buyingPrice).toLocaleString()}</span> : null}
