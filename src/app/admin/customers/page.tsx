        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
          <div className="space-y-3">
            ...
            <p className="max-w-3xl text-sm text-slate-400">
              Keep one harmonized customer list across legacy POS orders, POD deliveries, website orders, POS receipts, and agent orders, then expand any row to review purchase history, contact details, and linked order activity.
            </p>
          </div>
