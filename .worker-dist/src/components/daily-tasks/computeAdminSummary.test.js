...
const DailyTasksUI_1 = require("./DailyTasksUI");
describe("computeAdminSummary", () => {
    test("normal numeric input", () => {
        ...
        const s = (0, DailyTasksUI_1.computeAdminSummary)(dayState, market);
    ...
    test("decimals are summed and rounded appropriately", () => {
        const dayState = {};
        const market = { newUploaded: 0, copiesUploaded: 0, productsEdited: 0, sales: [{ id: "1", name: "A", price: 12500.5 }, { id: "2", name: "B", price: 499.5 }] };
        const s = (0, DailyTasksUI_1.computeAdminSummary)(dayState, market);
    ...
    test("string prices: numeric strings are coerced to numbers", () => {
        const dayState = {};
        const market = { newUploaded: 0, copiesUploaded: 0, productsEdited: 0, sales: [{ id: "1", name: "A", price: "2000" }, { id: "2", name: "B", price: 500 }] };
        const s = (0, DailyTasksUI_1.computeAdminSummary)(dayState, market);
    ...
    test("huge values handled safely", () => {
        const dayState = {};
        const market = { newUploaded: 0, copiesUploaded: 0, productsEdited: 0, sales: [{ id: "1", name: "A", price: 1000000 }, { id: "2", name: "B", price: 2000000 }] };
        const s = (0, DailyTasksUI_1.computeAdminSummary)(dayState, market);
        expect(s.totalSalesKES).toBe(3000000);
    });
    test("stringified numbers and missing fields", () => {
        const dayState = { promoVideosPosted: "1", demoVideosRecorded: false };
        const market = { newUploaded: "3", copiesUploaded: "", productsEdited: undefined, sales: [{ id: "1", name: "a", price: "50" }] };
        const s = (0, DailyTasksUI_1.computeAdminSummary)(dayState, market);
    ...
    test("negative prices clamped to zero and non-numeric ignored", () => {
        const dayState = {};
        const market = { newUploaded: 0, copiesUploaded: 0, productsEdited: 0, sales: [{ id: "1", name: "a", price: -10 }, { id: "2", name: "", price: 100 }, { id: "3", name: "c", price: "abc" }] };
        const s = (0, DailyTasksUI_1.computeAdminSummary)(dayState, market);
