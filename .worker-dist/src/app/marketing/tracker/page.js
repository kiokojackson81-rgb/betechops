...
function MarketingTrackerPage() {
    ...
    const periodLabel = periodSummary?.period.label ?? serverPeriodSummary?.period.label ?? "Loading current period\u2026";
