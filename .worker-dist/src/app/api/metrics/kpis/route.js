        ...
        try {
            ...
            if (allowLive) {
                ...
                for (const st of pendingStatuses) {
                    if (Date.now() - start >= LIVE_TIMEOUT_MS)
                ...
                if (pagesTotal > 0) {
                    ...
                    if (snapshotCandidate && (0, pendingSnapshot_1.isPendingSnapshotFresh)(snapshotCandidate, snapshotMaxAgeMs)) {
