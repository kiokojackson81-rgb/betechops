...
async function GET(_req, context) {
    ...
    try {
        ...
        // log upstream status + content-type for diagnostics
        console.info('[api/receipts/[id]/pdf] upstream fetch', { receiptId, upstreamStatus: upstream.status, upstreamContentType: upstream.headers.get('content-type') });
