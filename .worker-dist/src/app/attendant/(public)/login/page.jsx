...
exports.default = AttendantLoginPage;
const react_1 = require("next-auth/react");
const link_1 = __importDefault(require("next/link"));
function AttendantLoginPage() {
    return (<div className="relative min-h-screen overflow-hidden bg-[#0b0e13] text-slate-100">
        ...
        <div className="grid w-full gap-8 md:grid-cols-2">
          <section className="flex flex-col items-start justify-center">
            ...
            <div className="mt-6 text-xs text-slate-500 md:mt-10">
              <link_1.default href="/" className="underline underline-offset-2 text-slate-300 hover:text-white">← Back to Home</link_1.default>
            </div>
          </section>
...
function LoginButton() {
    return (<button onClick={() => (0, react_1.signIn)("google", { callbackUrl: "/attendant" })} className="group flex w-full items-center justify-center gap-3 rounded-xl border border-white/10 bg-white/5 px-5 py-3 font-semibold text-slate-100 transition hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-sky-400/50" aria-label="Continue with Google">
