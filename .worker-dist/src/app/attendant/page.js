...
function AttendantDashboard() {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "mx-auto max-w-7xl p-6 text-slate-100", children: [(0, jsx_runtime_1.jsxs)("div", { className: "mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h1", { className: "text-2xl font-semibold", children: "Attendant Dashboard" }), (0, jsx_runtime_1.jsx)("div", { className: "mt-2 flex flex-wrap gap-2 text-xs uppercase tracking-widest text-slate-300", children: definitions.map((def, idx) => ((0, jsx_runtime_1.jsxs)("span", { className: "inline-flex items-center gap-2 rounded-full border border-white/10 px-3 py-1", children: [(0, jsx_runtime_1.jsx)("span", { className: "font-semibold text-white", children: def.label }), idx === 0 ? (0, jsx_runtime_1.jsx)("span", { className: "rounded bg-emerald-500/20 px-1.5 py-0.5 text-[10px] text-emerald-200", children: "Primary" }) : null] }, def.id))) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-2 text-sm", children: [(0, jsx_runtime_1.jsx)("span", { className: "text-slate-400", children: "Shop:" }), (0, jsx_runtime_1.jsxs)("select", { className: "rounded-lg border border-white/10 bg-transparent px-2 py-1 outline-none", value: shopId || "", onChange: (e) => {
                                    ...
                                    if (val)
                                        ...
                                        localStorage.removeItem("shopId");
                                }, disabled: !shops.length && !loadingShops, children: [(0, jsx_runtime_1.jsx)("option", { value: "", children: "All" }), shops.map((shop) => ((0, jsx_runtime_1.jsxs)("option", { value: shop.id, children: [shop.name, " ", shop.platform ? `(${shop.platform})` : ""] }, shop.id)))] })] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "mb-6 flex items-center gap-4", children: [(0, jsx_runtime_1.jsxs)("div", { className: "kpi-card", children: [(0, jsx_runtime_1.jsx)("div", { className: "kpi-title", children: "Total products (recent)" }), (0, jsx_runtime_1.jsx)("div", { className: "kpi-value", children: summary ? summary.totalProducts : "—" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "kpi-card", children: [(0, jsx_runtime_1.jsx)("div", { className: "kpi-title", children: "Total sales (KES)" }), (0, jsx_runtime_1.jsx)("div", { className: "kpi-value", children: summary ? Number(summary.totalSales).toLocaleString() : "—" })] }), (0, jsx_runtime_1.jsx)("div", { className: "ml-4 text-sm opacity-70", children: "Recent uploads" }), (0, jsx_runtime_1.jsx)("div", { className: "sparkline", children: (0, jsx_runtime_1.jsx)(Sparkline_1.default, { values: recentReports.map((r) => r.productsCount), color: "var(--primary)" }) }), (0, jsx_runtime_1.jsx)("div", { className: "ml-auto", children: (0, jsx_runtime_1.jsx)(Button_1.default, { onClick: () => (window.location.href = "/attendant/daily-report"), variant: "primary", children: "Open daily report" }) })] }), loading ? ((0, jsx_runtime_1.jsx)("div", { className: "rounded-2xl border border-white/10 bg-white/5 p-6 text-center text-sm text-slate-400", children: "Loading your workspace\u2026" })) : shops.length || !loadingShops ? ((0, jsx_runtime_1.jsxs)("div", { className: "grid gap-6 lg:grid-cols-[1.2fr_.8fr]", children: [(0, jsx_runtime_1.jsx)("div", { className: "space-y-6", children: widgets.primary.length ? (widgets.primary.map((w) => (0, jsx_runtime_1.jsx)("div", { children: w.node }, w.id))) : ((0, jsx_runtime_1.jsx)("div", { className: "rounded-2xl border border-dashed border-white/10 p-6 text-center text-sm text-slate-400", children: "No widgets configured for this category yet." })) }), (0, jsx_runtime_1.jsx)("div", { className: "space-y-6", children: widgets.secondary.length ? widgets.secondary.map((w) => (0, jsx_runtime_1.jsx)("div", { children: w.node }, w.id)) : null })] })) : ((0, jsx_runtime_1.jsx)("div", { className: "rounded-2xl border border-dashed border-white/10 p-6 text-center text-sm text-slate-400", children: "You are not assigned to any active shop yet." }))] }));
}
