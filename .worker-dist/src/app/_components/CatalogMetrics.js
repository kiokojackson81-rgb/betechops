...
function CatalogMetrics({ initial, shopId, exact }) {
    ...
    return ((0, jsx_runtime_1.jsx)("section", { className: "grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-6", children: cards.map((card) => ((0, jsx_runtime_1.jsxs)("div", { className: `rounded-xl border px-4 py-3 shadow-sm ${metricTone(card.tone)}`, children: [(0, jsx_runtime_1.jsxs)("div", { className: "text-xs uppercase tracking-wide text-white/70 flex items-center justify-between", children: [(0, jsx_runtime_1.jsx)("span", { children: card.label }), card.key === "total" && loading && (0, jsx_runtime_1.jsx)("span", { className: "text-[10px] text-white/60", children: "loading\u2026" })] }), (0, jsx_runtime_1.jsx)("div", { className: "mt-2 text-2xl font-semibold", children: formatNumber(card.value) }), card.key === "total" && !exact && summary.approx ? (0, jsx_runtime_1.jsx)("div", { className: "text-xs text-amber-200/80", children: "Approximate" }) : null] }, card.key))) }));
}
