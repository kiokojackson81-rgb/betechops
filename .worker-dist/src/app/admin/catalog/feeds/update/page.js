...
function UpdateProductsFeedPage() {
    return ((0, jsx_runtime_1.jsxs)("div", { className: "p-6 space-y-4", children: [(0, jsx_runtime_1.jsx)("h1", { className: "text-2xl font-semibold", children: "Update Products Feed" }), (0, jsx_runtime_1.jsxs)("p", { className: "text-sm text-slate-400", children: ["Post a Products Update feed to Jumia. Include ", (0, jsx_runtime_1.jsx)("code", { children: "shopId" }), " when needed and ", (0, jsx_runtime_1.jsx)("code", { children: "products[]" }), " with updatable fields."] }), (0, jsx_runtime_1.jsx)(EndpointConsole_1.default, { endpoints: ENDPOINTS })] }));
}
