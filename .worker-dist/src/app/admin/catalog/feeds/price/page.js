...
function PriceFeedPage() {
    return ((0, jsx_runtime_1.jsxs)("div", { className: "p-6 space-y-4", children: [(0, jsx_runtime_1.jsx)("h1", { className: "text-2xl font-semibold", children: "Price Update Feed" }), (0, jsx_runtime_1.jsxs)("p", { className: "text-sm text-slate-400", children: ["Post a Price Update feed to Jumia. Payload: ", (0, jsx_runtime_1.jsxs)("code", { children: ['{', " products: [...] ", '}', " "] })] }), (0, jsx_runtime_1.jsx)(EndpointConsole_1.default, { endpoints: ENDPOINTS })] }));
}
