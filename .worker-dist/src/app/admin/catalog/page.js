...
async function CatalogPage({ searchParams }) {
    ...
    const renderChip = (chip, kind) => {
        ...
        return ((0, jsx_runtime_1.jsxs)("a", { href: href, className: `flex items-center gap-2 rounded-full border px-3 py-1 text-sm transition-colors ${isActive ? "border-emerald-400/40 bg-emerald-500/15 text-emerald-100" : "border-white/15 bg-white/5 text-slate-100 hover:border-white/25"}`, children: [(0, jsx_runtime_1.jsx)("span", { children: chip.label }), chip.count !== undefined ? (0, jsx_runtime_1.jsx)("span", { className: "text-xs text-slate-300", children: formatNumber(chip.count) }) : null] }, chip.key));
    };
    return ((0, jsx_runtime_1.jsxs)("div", { className: "space-y-6 p-6", children: [(0, jsx_runtime_1.jsxs)("header", { className: "flex flex-col gap-2", children: [(0, jsx_runtime_1.jsx)("h1", { className: "text-3xl font-semibold", children: "Catalog" }), (0, jsx_runtime_1.jsxs)("p", { className: "text-sm text-slate-300", children: [selectedShopName, !exact && summary.approx ? (0, jsx_runtime_1.jsx)("span", { className: "ml-2 text-amber-300", children: "Counts are approximate (first few pages)." }) : null] })] }), (0, jsx_runtime_1.jsx)(CatalogMetrics_1.default, { initial: summary, shopId: shopId, exact: exact }), (0, jsx_runtime_1.jsxs)("section", { className: "space-y-4 rounded-xl border border-white/10 bg-white/5 p-4", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { className: "text-xs font-medium uppercase tracking-wide text-slate-300", children: "QC Status" }), (0, jsx_runtime_1.jsx)("div", { className: "mt-2 flex flex-wrap gap-2", children: qcStatusChips.map((chip) => renderChip(chip, "qc")) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "border-t border-white/10 pt-4", children: [(0, jsx_runtime_1.jsx)("div", { className: "text-xs font-medium uppercase tracking-wide text-slate-300", children: "Listing Status" }), (0, jsx_runtime_1.jsx)("div", { className: "mt-2 flex flex-wrap gap-2", children: listingStatusChips.map((chip) => renderChip(chip, "status")) })] })] }), (0, jsx_runtime_1.jsx)("section", { className: "rounded-xl border border-white/10 bg-white/5 p-4", children: (0, jsx_runtime_1.jsxs)("form", { className: "grid gap-4 md:grid-cols-2 xl:grid-cols-6", children: [(0, jsx_runtime_1.jsx)("input", { type: "hidden", name: "status", value: listingStatusFilter ?? "" }), (0, jsx_runtime_1.jsx)("input", { type: "hidden", name: "qcStatus", value: qcStatusFilter ?? "" }), (0, jsx_runtime_1.jsx)("input", { type: "hidden", name: "exact", value: exact ? "true" : "" }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-1", children: [(0, jsx_runtime_1.jsx)("label", { className: "text-xs font-medium uppercase tracking-wide text-slate-300", children: "Shop" }), (0, jsx_runtime_1.jsxs)("select", { name: "shopId", defaultValue: shopId, className: "rounded border border-white/15 bg-slate-900/60 px-3 py-2 text-sm", children: [(0, jsx_runtime_1.jsx)("option", { value: "ALL", children: "All Jumia" }), shops.map((shop) => ((0, jsx_runtime_1.jsx)("option", { value: shop.id, children: shop.name }, shop.id)))] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-1", children: [(0, jsx_runtime_1.jsx)("label", { className: "text-xs font-medium uppercase tracking-wide text-slate-300", children: "Seller SKU" }), (0, jsx_runtime_1.jsx)("input", { name: "sellerSku", defaultValue: sellerSku ?? "", placeholder: "Search by SKU", className: "rounded border border-white/15 bg-slate-900/60 px-3 py-2 text-sm" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-1", children: [(0, jsx_runtime_1.jsx)("label", { className: "text-xs font-medium uppercase tracking-wide text-slate-300", children: "Category Code" }), (0, jsx_runtime_1.jsx)("input", { name: "categoryCode", defaultValue: categoryCode ? String(categoryCode) : "", placeholder: "e.g. 1000007", className: "rounded border border-white/15 bg-slate-900/60 px-3 py-2 text-sm" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-1", children: [(0, jsx_runtime_1.jsx)("label", { className: "text-xs font-medium uppercase tracking-wide text-slate-300", children: "Page Size" }), (0, jsx_runtime_1.jsx)("select", { name: "size", defaultValue: String(size), className: "rounded border border-white/15 bg-slate-900/60 px-3 py-2 text-sm", children: [20, 50, 100].map((n) => ((0, jsx_runtime_1.jsx)("option", { value: n, children: n }, n))) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-end gap-2 md:col-span-2 xl:col-span-2", children: [(0, jsx_runtime_1.jsx)("button", { className: "rounded border border-emerald-400/40 bg-emerald-500/20 px-4 py-2 text-sm font-medium text-emerald-100 hover:bg-emerald-500/30", children: "Apply" }), (0, jsx_runtime_1.jsx)("a", { href: "/admin/catalog", className: "rounded border border-white/15 bg-white/5 px-4 py-2 text-sm font-medium text-slate-100 hover:border-white/25", children: "Clear" })] })] }) }), (0, jsx_runtime_1.jsxs)("section", { className: "space-y-3", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between", children: [(0, jsx_runtime_1.jsx)("h2", { className: "text-lg font-semibold", children: "Categories" }), categoryCode ? ((0, jsx_runtime_1.jsx)("a", { href: `/admin/catalog?${buildQueryString({ ...baseQuery, categoryCode: undefined, token: undefined })}`, className: "text-xs text-emerald-200 underline", children: "Clear category" })) : null] }), categories.length === 0 ? ((0, jsx_runtime_1.jsx)("p", { className: "text-sm text-slate-400", children: "No categories available." })) : ((0, jsx_runtime_1.jsx)("div", { className: "flex gap-2 overflow-x-auto pb-2", children: categories.map((category, index) => {
                            ...
                            return ((0, jsx_runtime_1.jsxs)("a", { href: href, className: `min-w-[180px] rounded-lg border px-3 py-2 text-sm transition-colors ${isActive
                                    ? "border-emerald-400/40 bg-emerald-500/15 text-emerald-100"
                                    : "border-white/15 bg-white/5 text-slate-100 hover:border-white/25"}`, children: [(0, jsx_runtime_1.jsx)("div", { className: "font-medium", children: label }), (0, jsx_runtime_1.jsxs)("div", { className: "text-xs text-slate-300", children: ["Code: ", code] })] }, `cat-${code}-${label}`));
                        }) }))] }), (0, jsx_runtime_1.jsxs)("section", { className: "space-y-3", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between", children: [(0, jsx_runtime_1.jsx)("h2", { className: "text-lg font-semibold", children: "Products" }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-3 text-xs text-slate-400", children: [token ? (0, jsx_runtime_1.jsxs)("span", { children: ["token: ", token.slice(0, 6), "\u2026"] }) : null, (0, jsx_runtime_1.jsx)(AutoRefresh_1.default, { eventName: "catalog:counts:refresh", storageKey: "catalogAutoRefresh", intervalMs: 60000 }), (0, jsx_runtime_1.jsx)("a", { className: `rounded border px-3 py-1 text-xs ${exact
                                            ? "border-emerald-400/40 bg-emerald-500/15 text-emerald-100"
                                            : "border-white/15 bg-white/5 text-slate-100 hover:border-white/25"}`, href: `/admin/catalog?${buildQueryString({ ...baseQuery, exact: exact ? undefined : "true" })}`, title: exact ? "Switch to quick counts" : "Switch to exact counts", children: exact ? "Exact counts" : "Use exact counts" }), (0, jsx_runtime_1.jsx)(CountsRefreshButton_1.default, { shopId: shopId, exact: exact }), nextToken ? ((0, jsx_runtime_1.jsx)("a", { className: "rounded border border-white/15 bg-white/5 px-3 py-1 text-xs text-slate-100 hover:border-white/25", href: `/admin/catalog?${buildQueryString({ ...baseQuery, token: nextToken })}`, children: "Next \u2192" })) : null] })] }), shopId.toUpperCase() === "ALL" ? ((0, jsx_runtime_1.jsx)("div", { className: "text-sm text-slate-400", children: "Select a shop to view its product list. Aggregated products across all shops are skipped to keep the page fast." })) : normalizedProducts.length === 0 ? ((0, jsx_runtime_1.jsx)("p", { className: "text-sm text-slate-400", children: "No products match the current filters." })) : ((0, jsx_runtime_1.jsx)("div", { className: "overflow-x-auto rounded-xl border border-white/10", children: (0, jsx_runtime_1.jsxs)("table", { className: "min-w-full text-sm", children: [(0, jsx_runtime_1.jsx)("thead", { className: "bg-white/5 text-left text-xs uppercase tracking-wide text-slate-300", children: (0, jsx_runtime_1.jsxs)("tr", { children: [(0, jsx_runtime_1.jsx)("th", { className: "px-4 py-3", children: "Product" }), (0, jsx_runtime_1.jsx)("th", { className: "px-4 py-3", children: "QC Status" }), (0, jsx_runtime_1.jsx)("th", { className: "px-4 py-3", children: "Listing Status" }), (0, jsx_runtime_1.jsx)("th", { className: "px-4 py-3", children: "Price" }), (0, jsx_runtime_1.jsx)("th", { className: "px-4 py-3", children: "Sale Price" }), (0, jsx_runtime_1.jsx)("th", { className: "px-4 py-3", children: "Quantity" }), (0, jsx_runtime_1.jsx)("th", { className: "px-4 py-3", children: "Shop" }), (0, jsx_runtime_1.jsx)("th", { className: "px-4 py-3", children: "Updated" })] }) }), (0, jsx_runtime_1.jsx)("tbody", { children: normalizedProducts.map((product) => ((0, jsx_runtime_1.jsxs)("tr", { className: "border-t border-white/10", children: [(0, jsx_runtime_1.jsxs)("td", { className: "px-4 py-3", children: [(0, jsx_runtime_1.jsx)("div", { className: "font-medium text-white", children: product.name }), (0, jsx_runtime_1.jsx)("div", { className: "text-xs text-slate-400", children: product.sellerSku })] }), (0, jsx_runtime_1.jsx)("td", { className: "px-4 py-3", children: (0, jsx_runtime_1.jsx)("span", { className: `inline-flex items-center rounded-full border px-2 py-0.5 text-xs ${badgeClasses("qc", product.qcStatusKey)}`, children: formatLabel(product.qcStatusKey || "unknown") }) }), (0, jsx_runtime_1.jsx)("td", { className: "px-4 py-3", children: (0, jsx_runtime_1.jsx)("span", { className: `inline-flex items-center rounded-full border px-2 py-0.5 text-xs ${badgeClasses("listing", product.statusKey)}`, children: formatLabel(product.statusKey || "unknown") }) }), (0, jsx_runtime_1.jsx)("td", { className: "px-4 py-3 text-slate-100", children: formatCurrency(product.priceValue, product.currency) }), (0, jsx_runtime_1.jsx)("td", { className: "px-4 py-3 text-emerald-100", children: formatCurrency(product.salePriceValue, product.currency) }), (0, jsx_runtime_1.jsx)("td", { className: "px-4 py-3 text-slate-100", children: product.quantity !== undefined ? formatNumber(product.quantity) : "-" }), (0, jsx_runtime_1.jsx)("td", { className: "px-4 py-3 text-slate-100", children: product.shopName }), (0, jsx_runtime_1.jsx)("td", { className: "px-4 py-3 text-slate-300", children: formatDateTime(product.updatedAt) })] }, product.key))) })] }) }))] })] }));
}
