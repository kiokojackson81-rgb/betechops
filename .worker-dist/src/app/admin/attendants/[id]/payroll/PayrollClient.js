...
function PayrollClient({ attendant, initialPlan, periodKey, periodLabel, initialAdjustments, initialSummary, }) {
    ...
    const [newAdjustment, setNewAdjustment] = (0, react_1.useState)({ adjustmentType: "BONUS", label: "", amount: "" });
    (0, react_1.useEffect)(() => {
