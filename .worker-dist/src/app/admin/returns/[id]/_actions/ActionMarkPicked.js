...
function ActionMarkPicked({ returnId, disabled }) {
    ...
    return ((0, jsx_runtime_1.jsx)("button", { onClick: onClick, disabled: disabled, className: "rounded-xl border border-white/10 px-4 py-2 hover:bg-white/10 disabled:opacity-60 disabled:cursor-not-allowed", children: "Mark Picked Up" }));
}
