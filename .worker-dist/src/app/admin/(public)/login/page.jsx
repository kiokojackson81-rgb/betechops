        ...
        <div className="grid w-full gap-10 md:grid-cols-2">
          ...
          <section className="flex items-center justify-center">
            <div className="w-full max-w-md rounded-2xl border border-white/10 bg-[linear-gradient(135deg,rgba(18,22,32,.9),rgba(18,22,32,.7))] p-6 shadow-[0_10px_30px_rgba(0,0,0,.35)] backdrop-blur">
              <button onClick={() => (0, react_1.signIn)("google", { callbackUrl: "/admin" })} className="group flex w-full items-center justify-center gap-3 rounded-xl bg-yellow-400 px-5 py-3 font-semibold text-black transition hover:bg-yellow-300 focus:outline-none focus:ring-2 focus:ring-yellow-400/60" aria-label="Continue with Google">
                {/* Google 'G' */}
