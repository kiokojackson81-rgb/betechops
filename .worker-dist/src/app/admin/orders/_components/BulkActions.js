...
function BulkActions() {
    ...
    if (!shopId)
        return null;
    return ((0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-2 md:flex-row md:items-center md:justify-between rounded-xl border border-white/10 bg-[var(--panel,#121723)] p-3", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-2", children: [(0, jsx_runtime_1.jsx)("span", { className: "text-sm opacity-80", children: "Default station for this shop:" }), (0, jsx_runtime_1.jsx)("input", { className: "px-2 py-1 rounded bg-black/20 border border-white/10 min-w-[16rem]", placeholder: "Provider ID (e.g. LUCYTEC-PROVIDER-ID)", value: providerId, onChange: (e) => setProviderId(e.target.value), disabled: !defaultsLoaded || !!busy }), providerName && ((0, jsx_runtime_1.jsx)("span", { className: "text-xs opacity-80 px-2 py-1 rounded border border-white/10 bg-white/5", title: providerId, children: providerName })), (0, jsx_runtime_1.jsx)("button", { className: "px-3 py-1 rounded border border-white/10 hover:bg-white/10 disabled:opacity-50", onClick: saveDefault, disabled: !providerId || !!busy, title: "Save as default shipping station for this shop", children: busy === "save-default" ? "Saving…" : "Save" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-2", children: [(0, jsx_runtime_1.jsx)("button", { className: "px-3 py-1 rounded border border-white/10 hover:bg-white/10 disabled:opacity-50", onClick: () => run("pack"), disabled: !!busy, title: "Pack all PENDING items for this shop using the default station", children: busy === "pack" ? "Packing…" : "Pack all" }), (0, jsx_runtime_1.jsx)("button", { className: "px-3 py-1 rounded border border-white/10 hover:bg-white/10 disabled:opacity-50", onClick: () => run("rts"), disabled: !!busy, title: "Mark all PACKED items Ready-To-Ship for this shop", children: busy === "rts" ? "Marking…" : "RTS all" }), (0, jsx_runtime_1.jsx)("button", { className: "px-3 py-1 rounded border border-white/10 hover:bg-white/10 disabled:opacity-50", onClick: () => run("print"), disabled: !!busy, title: "Print labels for all RTS/SHIPPED/DELIVERED items for this shop", children: busy === "print" ? "Printing…" : "Print all" })] })] }));
}
