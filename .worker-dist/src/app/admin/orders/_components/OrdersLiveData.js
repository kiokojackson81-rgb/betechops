...
function OrdersLiveData({ initialRows, initialNextToken, initialIsLastPage, params, disableClientFetch = false, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "space-y-2", children: [(0, jsx_runtime_1.jsxs)("div", { className: "text-xs text-slate-500", children: ["Updated: ", lastUpdatedLabel] }), (0, jsx_runtime_1.jsx)(OrdersTable_1.default, { rows: rows, nextToken: nextToken, isLastPage: isLastPage })] }));
}
