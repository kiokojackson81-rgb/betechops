...
function SyncNowButton({ className }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: className, children: [(0, jsx_runtime_1.jsx)("button", { onClick: run, disabled: busy, className: "rounded-md bg-slate-800/60 border border-white/10 px-3 py-2 text-sm hover:bg-white/10 disabled:opacity-60", title: "Run incremental sync now", children: busy ? "Syncing." : "Sync now" }), msg && (0, jsx_runtime_1.jsx)("span", { className: "ml-2 text-xs text-slate-400", children: msg })] }));
}
