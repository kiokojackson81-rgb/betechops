...
async function OrdersPage(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "space-y-6", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-2 md:flex-row md:items-start md:justify-between", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h1", { className: "text-2xl md:text-3xl font-bold", children: "Orders" }), (0, jsx_runtime_1.jsx)("p", { className: "text-slate-300", children: showingSynced
                                    ? `Showing synced ${statusMessageLower} orders from Jumia accounts. Filters apply instantly.`
                                    : 'Filter by status, country, shop, and date range. Use actions to pack, mark RTS, or print labels.' }), syncFallbackMessage && ((0, jsx_runtime_1.jsx)("p", { className: "text-xs text-amber-400 mt-1", children: syncFallbackMessage })), showingSynced && prefersSynced && ((0, jsx_runtime_1.jsx)("p", { className: "text-xs text-slate-400 mt-1", children: isPendingView
                                    ? 'Synced pending view uses no fixed date window; showing full vendor-backed range.'
                                    : 'Synced view shows the rolling 90-day retention window stored in our database.' })), !prefersSynced && (usedDefaultFrom || usedDefaultTo) && ((0, jsx_runtime_1.jsx)("p", { className: "text-xs text-slate-400 mt-1", children: `Default window: last 3 months (bounded by system start). Showing ${params.dateFrom} to ${params.dateTo}.` }))] }), (0, jsx_runtime_1.jsxs)("div", { className: "pt-1 flex items-center gap-4", children: [(0, jsx_runtime_1.jsx)(SyncNowButton_1.default, {}), (0, jsx_runtime_1.jsx)(OrdersSSE_1.default, { status: params.status, country: params.country, shopId: params.shopId, dateFrom: params.dateFrom, dateTo: params.dateTo, intervalMs: 4000 }), (0, jsx_runtime_1.jsx)(AutoRefresh_1.default, { storageKey: "autoRefreshOrders", intervalMs: 10000, defaultEnabled: true }), (0, jsx_runtime_1.jsx)("a", { href: "/admin/settings/jumia/shipping-stations", className: "px-3 py-1 rounded border border-white/10 hover:bg-white/10 text-sm", title: "Configure per-shop default shipping stations", children: "Shipping Stations" })] })] }), (0, jsx_runtime_1.jsx)(OrdersFilters_1.default, { shops: shopOptions }), (0, jsx_runtime_1.jsx)(BulkActions_1.default, {}), (0, jsx_runtime_1.jsx)(OrdersLiveData_1.default, { initialRows: rows, initialNextToken: nextToken, initialIsLastPage: isLastPage, params: {
